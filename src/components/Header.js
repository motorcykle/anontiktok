      ...
      <nav className="py-2 px-10 shadow-md">
        <div className="container flex items-center justify-between mx-auto">
          <Link to="/" className="">
            ...
            <button className="block sm:hidden py-2 px-6 rounded-full border-2 hover:bg-gray-100">
          ...
          <Link to="/">
            <button className="py-2 px-6 rounded-3xl border-2 font-semibold text-gray-400 hover:bg-gray-100 flex items-center space-x-1" onClick={() => auth.signOut()}>
